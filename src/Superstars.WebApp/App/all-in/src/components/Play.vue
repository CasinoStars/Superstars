  ...
  <div class="row play">
    <div class="col-md-4 yams">
      <router-link v-on:click.native="PlayYams(0)" to="" class="routeryams">
        <img src="../img/LOGO1.png" alt="yams" class="animated bounceIn imgyams">
      </router-link>
      <p style="font-family: Bebas; font-size: 5.2vh; text-align: center; text-shadow: 2px 2px 3px #000000;" class="animated bounceIn"> Yam's </p>
    </div>

    <div class="col-md-4 blackjack">
      <router-link v-on:click.native="PlayBlackJack(1)" to="" class="routerbj">
        <img src="../img/LOGO3.png" alt="blackjack" class="animated bounceIn imgblackjack">
      </router-link>
      <p style="font-family: Bebas; font-size: 5.2vh; text-align: center; text-shadow: 2px 2px 3px #000000;" class="animated bounceIn"> BlackJack </p>
    </div>

    <div class="col-md-4 crash">
      <router-link to="/crash" class="routercrash">
        <img src="../img/LOGO5.png" alt="crash" class="animated bounceIn imgcrash">
      </router-link>
      <p style="font-family: Bebas; font-size: 5.2vh; text-align: center; text-shadow: 2px 2px 3px #000000;" class="animated bounceIn"> Crash </p>
    </div>
  </div>
  </div>
</template>
