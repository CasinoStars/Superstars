  ...
  <div class="provablyfair">
    ...
    <div class="form" style="letter-spacing: 2px; font-family: 'Courier New', sans-serif;">
      ...
      <ul class="tab-group">
        ...
        <li style="color: white" class="tab active" v-if="this.view == 'provablyFairTest'"><a v-on:click="ChangeView('provablyFairTest')">Retrouver
            les dés</a></li>
        <li style="color: white" class="tab" v-else><a v-on:click="ChangeView('provablyFairTest')">Retrouver les dés</a></li>


        <li style="color: white" class="tab active" v-if="this.view == 'provablyFairCode'"><a v-on:click="ChangeView('ProvablyFairCode')"
            style="margin-leftg: 25%;">Code</a></li>
        ...
        <div class="tab-content">
          ...
          <form @submit="RetriveDicesFromSeeds($event)">
            ...
            <div class="field-wrap">
              ...
              <input type="string" min="0" max="1000000" placeholder="Nouvelle seed client" v-model="serverSeedTest"
                required autocomplete="off" />
            </div>
            <div class="field-wrap">
              <label style="margin-left: 45%; ">
              ...
              <input type="int" min="0" max="1000000" placeholder="Nouvelle seed client" v-model="nbOfDices" required
                autocomplete="off" />
            </div>
      ...
      <div class="tab-content" v-if="this.view == 'provablyFairCode'">
        <h6 style="color: white"><span style="font-weight: bold; font-style: italic;">
